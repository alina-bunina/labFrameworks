...
public class ProfileRepository {
    ...
    private final String GET_BY_LOGIN_TEMPLATE = "SELECT id, login, password_hash, salt FROM profile WHERE login = ?";
    private static final String CHECK_LOGIN_EXIST_QUERY = "SELECT id FROM profile WHERE login = ?";
